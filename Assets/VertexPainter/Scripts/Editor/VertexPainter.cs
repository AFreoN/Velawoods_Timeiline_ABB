                    ...
                    case global::ColorPaintMode.Hue:
                        {
                            ...
                            Color.RGBToHSV(colrs[i], out H, out S, out V);
                            Color.RGBToHSV(currentColor, out H2, out S2, out V2);

                            colrs[i] = Color.HSVToRGB(Mathf.Lerp(H, H2, finalBlendFactor), S, V);
                    ...
                    case global::ColorPaintMode.Color:
                        {
                            ...
                            colrs[i] = Color.HSVToRGB(Mathf.Lerp(H, H2, finalBlendFactor), Mathf.Lerp(S, S2, finalBlendFactor), V);
                            rc = colrs[i].r; gc = colrs[i].g; bc = colrs[i].b; ac = colrs[i].a;
