...
public class HideIfAttribute : PropertyAttribute
{
    ...
    public HideIfAttribute(string comparedPropertyName, object comparedValue, ComparisonType comparisonType, DisablingType disablingType = DisablingType.DontDraw)
    {
