...
public class MayaFileTexture {
	...
	// Constructor
	// --------------------------------------------------
	public MayaFileTexture(Texture t, int FileCount, string sourcePath, string destinationPath){
		UnityTexture = t;
		MayaFileName = ("file" + FileCount);
		MayaPlacementName = ("place2dTexture" + FileCount);
