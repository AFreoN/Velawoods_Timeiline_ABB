...
public class DragAndDropMultiChoiceAcceptor : TouchZone
{
    public int Index = 0;

	public delegate void DraggableCallback(int index);
	...
	protected virtual void TouchZoneUp(object accepter)
	{
		...
		if(heldObject != null)
		{
            O2DragToAnyDraggableObject heldDraggableScript = heldObject.GetComponent<O2DragToAnyDraggableObject>();
	...
	protected void AddToContents(GameObject content)
	{
        ...
        O2DragToAnyDraggableObject heldDraggableScript = content.GetComponent<O2DragToAnyDraggableObject>();
